...
public class UserAuthMapsStripper {
     ...
     * from the eBay JSON map and constructs a UserRefreshTokenEntity object.
     *
     * @param ebayRefreshTokenJsonMap The eBay JSON map
     *                               containing the refresh token and its expiration time.
     * @return A UserRefreshTokenEntity object
     * initialized with the extracted refresh token and expiration time.
     */
    public UserRefreshTokenEntity stripRefreshTokenFromEbayJsonMap(
            Map<?, ?> ebayRefreshTokenJsonMap
    ) {
     ...
     * from the eBay JSON map and constructs a UserAccessTokenEntity object.
     *
     * @param ebayRefreshTokenJsonMap The eBay JSON map
     *                               containing the access token and its expiration time.
     * @return A UserAccessTokenEntity object
     * initialized with the extracted access token and expiration time.
     */
    public UserAccessTokenEntity stripAccessTokenFromEbayJsonMap(
            Map<?, ?> ebayRefreshTokenJsonMap
    ) {
